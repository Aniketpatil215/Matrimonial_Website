    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (btn.equals("SignIn")) {
            ...
            try {
                ...
                String sql = "select * from user_signin where email='" + email + "' ";
                ...
                if (rs.next()) {
                    ...
                    String insert = ("insert into user_signin (fname,lname,radio,dob,email,contact,pass)values ('" + fname + "','" + lname + "','" + radio + "','" + dob + "','" + email + "','" + contact + "','" + pass + "')");
        ...
        if (btn.equals("Cancel")) {
            ...
            String delete = "delete from user_signin  where fname='" + fname + "'";
        ...
        if (btn.equals("Save")) {
            String update = ("update  user_signin set pass='" + pass + "' where email='" + email + "'");
