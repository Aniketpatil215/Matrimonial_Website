...
public final class All_005fdetails_005fuser_005fprofie_005fadmin_005fside_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>All_details_user_profie_admin_side</title>\n");
      ...
      out.write("        ");
            ...
            try {
                ...
                String sql = "select * from user_signin where id='" + request.getParameter("uid") + "' ";
            ...
            try {
                ...
                cn = DriverManager.getConnection("jdbc:mysql://localhost:3307/online_matrimonial_website", "root", "root");
                st = cn.createStatement();
                String sql = "select * from basic_details where uid='" + request.getParameter("uid") + "' ";
                ResultSet rs = st.executeQuery(sql);
                while (rs.next()) {
            ...
            try {
                ...
                cn = DriverManager.getConnection("jdbc:mysql://localhost:3307/online_matrimonial_website", "root", "root");
                st = cn.createStatement();
                String sql = "select * from Ethinicity where uid='" + request.getParameter("uid") + "' ";
                ResultSet rs = st.executeQuery(sql);
                while (rs.next()) {
            ...
            try {
                ...
                cn = DriverManager.getConnection("jdbc:mysql://localhost:3307/online_matrimonial_website", "root", "root");
                st = cn.createStatement();
                String sql = "select * from Social where uid='" + request.getParameter("uid") + "' ";
                ResultSet rs = st.executeQuery(sql);
                while (rs.next()) {
            ...
            try {
                ...
                cn = DriverManager.getConnection("jdbc:mysql://localhost:3307/online_matrimonial_website", "root", "root");
                st = cn.createStatement();
                String sql = "select * from Lifestyle where uid='" + request.getParameter("uid") + "' ";
                ResultSet rs = st.executeQuery(sql);
                while (rs.next()) {
            ...
            try {
                ...
                cn = DriverManager.getConnection("jdbc:mysql://localhost:3307/online_matrimonial_website", "root", "root");
                st = cn.createStatement();
                String sql = "select * from Career where uid='" + request.getParameter("uid") + "' ";
                ResultSet rs = st.executeQuery(sql);
                while (rs.next()) {
            ...
            try {
                ...
                cn = DriverManager.getConnection("jdbc:mysql://localhost:3307/online_matrimonial_website", "root", "root");
                st = cn.createStatement();
                String sql = "select * from Working where uid='" + request.getParameter("uid") + "' ";
                ResultSet rs = st.executeQuery(sql);
                while (rs.next()) {
            ...
            try {
                ...
                cn = DriverManager.getConnection("jdbc:mysql://localhost:3307/online_matrimonial_website", "root", "root");
                st = cn.createStatement();
                String sql = "select * from Family where uid='" + request.getParameter("uid") + "' ";
                ResultSet rs = st.executeQuery(sql);
                while (rs.next()) {
      ...
      out.write("                                        <p class=\"mb-0\">User ID :");
      out.print(uid);
      out.write("</p>\n");
      out.write("                                    </div>\n");
      out.write("\n");
      out.write("                                    <div class=\"col-sm-6\">\n");
      out.write("                                        <p class=\"mb-0\">Age :");
      out.print(age);
      out.write("</p>\n");
      out.write("                                    </div>\n");
      out.write("\n");
      ...
      out.write("                                <div class=\"row\">\n");
      out.write("                                    <div class=\"col-sm-6\">\n");
      out.write("                                        <p class=\"mb-0\">DOB :");
      out.print(dob);
      out.write("</p>\n");
      out.write("                                    </div>\n");
      out.write("\n");
      out.write("                                    <div class=\"col-sm-6\">\n");
      out.write("                                        <p class=\"mb-0\">Gender:");
      out.print(gender);
      out.write("</p>\n");
      out.write("                                    </div>\n");
      out.write("                                </div>\n");
