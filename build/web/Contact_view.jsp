<%-- 
    Document   : Contact_view
    Created on : 10 Mar, 2023, 10:39:34 AM
    Author     : Aniket
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <br>
            <h1  style=" margin-top: 80px;">Contact Details View list</h1>
            <br>
            ...
            <table class="table table-bordered ">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Suitable Time to Call</th>
                ...
                <tbody>
                    ...
                    <%
                        ...
                        if (btn != null) {
                            ...
                            sql = "select * from Contact where uid='" + session.getAttribute("uid") + "' ";
                        }
                    ...
                    %>
                    <tr>
                <form action="Contact_Update.jsp" method="post">
                    ...
                    <input type="hidden" name="dtime" value="<%=rs.getString("dtime")%>">
