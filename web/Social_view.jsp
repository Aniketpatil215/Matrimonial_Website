<%-- 
    Document   : Social_view
    Created on : 10 Mar, 2023, 9:22:35 PM
    Author     : Aniket
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <br>
            <h1 style=" margin-top: 80px;">Social Details View list</h1>
            <br>
                ...
                <tbody>
                    ...
                    <%
                        ...
                        if (btn != null) {
                            ...
                            sql = "select * from Social where uid='" + session.getAttribute("uid") + "' ";
                        }
                    ...
                    %>
                    <tr>
                <form action="Social_Update.jsp" method="post">
                    ...
                    <input type="hidden" name="marital_status" value="<%=rs.getString("marital_status")%>">

                    <td><%=rs.getString("mother_tongue")%></td>
                    <input type="hidden" name="mother_tongue" value="<%=rs.getString("mother_tongue")%>">

                    <td><%=rs.getString("religion_cast")%></td>
                    <input type="hidden" name="religion_cast" value="<%=rs.getString("religion_cast")%>">

                    <td><%=rs.getString("horoscope")%></td>
                    <input type="hidden" name="horoscope" value="<%=rs.getString("horoscope")%>">
