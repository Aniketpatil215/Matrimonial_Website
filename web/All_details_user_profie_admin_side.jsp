<%-- 
    Document   : All_details_user_profie_admin_side
    Created on : 2 Apr, 2023, 4:53:36 PM
    Author     : Aniket
--%>
                        ...
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                ...
                                <div >
                                    ...
                                    <button type="button" class="btn btn-danger">Express Interest</button>

                                    <button type="button"  class="btn btn-outline-primary ms-1">Send Email</button>
                                </div>
                            </div>
                        </div>
