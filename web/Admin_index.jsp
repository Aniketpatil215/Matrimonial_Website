    ...
    <body>
        ...
        <div class="banner-w3ls" id="home">
            <div class="container">
                ...
                <div class="header-inner">
                    <h1 class="logo">
                        <a href="Admin_index.jsp">Matrimonial<span>Website</span></a>
                    </h1>
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="Admin_index.jsp" class="active">Home</a></li>
                ...
                <div class="clearfix"></div>
                <!-- //banner-slider -->
                <div class="sim-button button12"><a href="Admin_about.html">More About Us</a></div>
        ...
        <div class="search-wthree">
            <div class="container">
                ...
                <div class="sim-button button12"><a href="Admin_register.html">Join Now</a></div>
                <div class="clearfix"> </div>
            </div>
        </div>
        <!--//search-section -->
        ...
        <div class="middle-section-agileits-w3layouts">
            <div class="container">
                ...
                <div class="sim-button button12"><a href="Admin_contact.html">Contact Us</a></div>
            </div>
        </div>
        <!--//middle-section -->
        <!-- testimonials -->
